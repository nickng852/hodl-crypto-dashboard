                ...
                {slicedCoins?.map((result, index) => {
                    ...
                    return (
                        <SwiperSlide key={index}>
                            <Link to={`/coin/${id}`}>
                                <div className="relative w-full overflow-hidden rounded-3xl bg-white dark:bg-secondary">
                                    <img
                                        src={icon}
                                        alt={name}
                                        className="absolute right-4 top-4 h-14 w-14 opacity-95 md:h-16 md:w-16 2xl:h-20 2xl:w-20"
                                    />

                                    <div className="px-4 py-5 sm:p-5">
                                        <dl>
                                            <span className="truncate rounded-md bg-gray-200 px-2 py-1 text-xs font-medium leading-5 text-gray-600">
                                                {symbol}
                                            </span>
